        ...
        <div className="grid lg:grid-cols-2 bg-white/95 shadow-2xl rounded-3xl overflow-hidden w-full max-w-5xl border border-white/40">
          <div className="hidden lg:flex flex-col justify-center bg-blue-950/95 text-white p-12">
            ...
            <p className="text-blue-100 leading-8 mb-8">
              Create your account to join university clubs, register for
              events, receive announcements, and take part in campus activities.
            </p>

            <div className="space-y-5">
              <Info
                icon={<GraduationCap />}
                text="Students can join multiple clubs"
              />
              <Info icon={<Users />} text="Club leaders manage one club" />
              <Info icon={<ShieldCheck />} text="Admin access is protected" />
            </div>
          </div>
